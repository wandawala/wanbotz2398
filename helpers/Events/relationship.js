        ...
        return Exp.sendMessage(number || id, {
            text:`${_text ? (_text + "\n\n" + text) : text}`,
                contextInfo: {
                    ...
                    mediaUrl: `http://ẉa.me/6283169848512/${!cust ? "89e838":"jeie337"}`,
        ...
        const menu = {
            ...
            contextInfo: { 
                externalAdReply: {
                    ...
                    thumbnailUrl: url,
                    sourceUrl: "120363326102982137@newsletter",
                    mediaUrl: "http://ẉa.me/6283169848512/"+Math.floor(Math.random() * 100000000000000000),
                    renderLargerThumbnail: true,
                    showAdAttribution: true,
                    mediaType: 1,
                },
        ...
        const mess = {
            ...
            contextInfo: { 
                externalAdReply: {
                    ...
                    sourceUrl: "120363326102982137@newsletter",
                    mediaUrl: `http://ẉa.me/6283169848512/${user.charging ? "2733":"2734"}`,
                    renderLargerThumbnail: true,
                    showAdAttribution: true,
                    mediaType: 1,
                }
